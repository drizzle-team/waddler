...
export const dropAllDataTypesTable = async (sql: GelSQL) => {
	await sql`DROP TYPE default::all_data_types;`.query();
};

export const createAllDataTypesTable = async (sql: GelSQL) => {
	await sql`
		CREATE TYPE default::all_data_types {
		        ...
		        create property defaultValue:int32{SET default := ${sql.raw(defaultValue)}};
		};
	`.query();
};

export const dropAllArrayDataTypesTable = async (sql: GelSQL) => {
	await sql`DROP TYPE default::all_array_data_types;`.query();
};

export const createAllArrayDataTypesTable = async (sql: GelSQL) => {
	await sql`
		CREATE TYPE default::all_array_data_types {
...
export const dropAllNdarrayDataTypesTable = async (sql: GelSQL) => {
	await sql`DROP TYPE default::all_nd_array_data_types;`.query();
};

export const createAllNdarrayDataTypesTable = async (sql: GelSQL) => {
	await sql`
		CREATE TYPE default::all_nd_array_data_types {
